<body>
    <table style="width: 100%; height: auto">
        <tr>
            <th><h2 style="padding:20px">Имя заказчика : <strong>{{$name}}</strong></h2></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align: left; font-size: larger; font-style: italic; font-weight: bold; width: 50%">{{$mail}}</td>
        </tr>
        <tr>
